    ...
    try {
      ...
      const tx = new Transaction().add(
        ...
        createInitializeMintInstruction(
          ...
          publicKey,
          revokeMintAuthority ? null : publicKey, // Если revokeMintAuthority, то мы не передаем freezeAuthority
          TOKEN_PROGRAM_ID
        ),
        ...
        createCreateMetadataAccountV3Instruction(
          {
            ...
            payer: publicKey,
            updateAuthority: publicKey, // Если revokeUpdateAuthority, то не передаем updateAuthority
          },
          {
